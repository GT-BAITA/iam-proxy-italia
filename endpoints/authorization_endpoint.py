...
class AuthorizationHandler(BaseEndpoint):
    ...
    def endpoint(self, context, *args):
        ...
        authorization_endpoint = trust_chain.subject_configuration.payload["metadata"][
            "openid_provider"
        ]["authorization_endpoint"]
    ...
    def __pkce_generation(self, authz_data: dict):
        ...
        code_challenge_length: int = self.config["metadata"]["openid_relying_party"][
            "code_challenge"
        ]["length"]

        code_challenge_method: str = self.config["metadata"]["openid_relying_party"][
            "code_challenge"
        ]["method"]
